          ...
          <div className="lg:flex flex-row-reverse text-slate-400">
            ...
            <div className="lg:w-1/2">
              <p>
                ...
                student in Computer Science and Engineering, blending creativity
                with technical expertise to build modern, responsive web
                applications. My journey in tech is fueled by a deep enthusiasm
                for learning and exploring new tools and technologies.
              </p>
              <br />
              <p>
                With a strong foundation in JavaScript and Node.js, I’m adept at
                both front-end and back-end development, creating seamless,
                interactive user experiences and robust backend services. On the
                front end, I excel in designing responsive, visually appealing
                interfaces using React, Tailwind CSS, and Bootstrap. For the
                back end, I leverage tools like Node.js, Express.js, MongoDB,
                and MySQL to build scalable and efficient APIs and databases.
              </p>
              <br />
              ...
              <p>
                ...
                enhancing my skills, and crafting projects that solve real-world
